    ...
    btn.addEventListener("click", function() {
        ...
        if (this.textContent === "แก้ไข") {
            ...
            function updateTotal() {
                let qtyStr = qtyInput.value.trim() || "0";
                let priceStr = priceInput.value.trim() || "0";
                // ใช้ parseFloat เฉพาะคำนวณ total แบบ internal แต่ไม่ใช้ toFixed
                let total = (parseFloat(qtyStr) * parseFloat(priceStr)).toString();
                totalCell.innerHTML = `<input value="${total}">`;
            }
