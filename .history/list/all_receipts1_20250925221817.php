...
const scrollTable = document.querySelector(".scrollable-table");
const firstColWidth = scrollTable.querySelector("th").offsetWidth;

document.querySelector(".scroll-btn.left").addEventListener("click", () => {
    scrollTable.scrollBy({ left: -firstColWidth, behavior: "smooth" });
});
