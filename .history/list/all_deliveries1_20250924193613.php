            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td class='editable col-total'>" . number_format($row['total'],2) . "</td>";
                        ...
                        $pdf_link = $pdf_file ? "../uploads/deliveries/" . $pdf_file : "#";
                        echo "<td>";
echo "<a class='action-btn btn-viewpdf' href='{$pdf_link}' download>ดาวน์โหลด PDF</a>";
echo "<input type='file' class='upload-pdf' data-delivery-id='{$row['delivery_id']}'>";
