...
<body>
<div class="sidebar">
    <a href="list/all_quotations1.php">ใบเสนอราคา</a>
    <a href="list/all_deliveries1.php">ใบส่งของ</a>
    <a href="list/all_receipts1.php">ใบเสร็จรับเงิน</a>
</div>
...
<div class="content">
    ...
    <button id="nextPage" class="scroll-btn">➡</button>
</div>
    ...
    for (let i = 1; i < rows.length; i++) {
        ...
        if (cell) {
            ...
            if (text.includes(input)) {
                rows[i].dataset.hidden = "false";
            } else {
                rows[i].dataset.hidden = "true";
