...
.topbar {
  background: #d4b295;
  padding: 15px 0;           /* เพิ่ม padding ให้ชิด logo แต่ไม่ชนเนื้อหา */
  text-align: center;
  margin-bottom: 25px;       /* เว้นระยะห่างกับ h2 / ตาราง */
  box-sizing: border-box;
  border-radius: 6px 6px 0 0; /* มุมบนโค้งเล็กน้อย */
  box-shadow: 0 2px 5px rgba(0,0,0,0.1); /* เงาเล็กๆ ดูนุ่ม */
}
.topbar img {
  max-height: 60px;
  display: block;
