    ...
    btn.addEventListener("click", function() {
        ...
        if (this.textContent === "แก้ไข") {
            ...
            function updateTotal() {
                ...
                // ถ้ากรอกค่าว่าง → เป็น 0
                if (!qtyStr) qtyStr = "0";
                if (!priceStr) priceStr = "0";
                // คำนวณ total สำหรับแสดงใน input
                let total = (Number(qtyStr) * Number(priceStr)).toString();
                // แสดงตรง ๆ ใน input (ไม่ใช้ toFixed)
