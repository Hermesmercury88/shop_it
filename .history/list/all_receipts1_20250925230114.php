...
<div class="scrollable-table" style="overflow-x: auto;">
    ...
    <button id="prevPage" class="scroll-btn">⬅ ก่อนหน้า</button>
    <span id="pageInfo"></span>
    <button id="nextPage" class="scroll-btn">ถัดไป ➡</button>
</div>
...
function renderTable() {
    ...
    // เลือกแถวที่ไม่ถูกซ่อนจากการ search
    let visibleRows = [];
    for (let i = 1; i < rows.length; i++) {
        if (rows[i].style.display !== "none") {
