...
<div class="content">
    ...
    <div class="table-wrapper" style="position: relative; max-height: 400px; overflow: hidden;">
    <button class="scroll-btn up">▲</button>
    <button class="scroll-btn down">▼</button>

    <div class="scrollable-table" style="overflow-y: auto; max-height: 400px;">
...
document.querySelector(".scroll-btn.left").addEventListener("click", () => {
    scrollTable.scrollBy({ left: -colWidth, behavior: "smooth" });
});
