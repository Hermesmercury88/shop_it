    ...
    btn.addEventListener("click", function() {
        ...
        if (this.textContent === "แก้ไข") {
            tds.forEach((td, index) => {
                ...
                td.innerHTML = `<input value="${val}" style="width:100%; text-align:center;">`;
            });

            // ✅ ให้คำนวณราคารวมอัตโนมัติ (qty * price)
            let qtyInput   = tds[5].querySelector("input"); // คอลัมน์จำนวน
            let priceInput = tds[6].querySelector("input"); // คอลัมน์ราคา
            let totalInput = tds[8].querySelector("input"); // คอลัมน์ราคารวม
