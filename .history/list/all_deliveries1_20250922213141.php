...
@media print {
    @page {
        size: A5 portrait; /* ใช้กระดาษ A5 แนวตั้ง */
        margin: 10mm;      /* เว้นขอบกระดาษ */
    }
    ...
    .btn-pdf,
    .topbar {
        display: none !important; /* ซ่อน sidebar, search, topbar, ปุ่ม PDF */
    }
    ...
    table {
        border-collapse: collapse;
        width: 100%;
        border: 2px solid #000; /* เส้นขอบชัด */
    }

    th, td {
        border: 1px solid #000; /* เส้นขอบชัด */
        padding: 6px;
        text-align: center;
    }
